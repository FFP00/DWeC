...
export default function App() {
  ...
  const filteredGames = games.filter(e => e.name.toLowerCase().includes(query.toLowerCase()));
      ...
      <main>
        ...
        <section>
          <div className='search-container'>
            <input type="text" value={query} name="search" placeholder='search game' onChange={(e) => { setQuery(e.target.value) }} />
          </div>
