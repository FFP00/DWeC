                     ...
                     <div className="row g-0">
                        ...
                        <div className="col-md-8">
                           <div className="card-body text-start mt-2">
                              ...
                              <h5 className="card-text">{KelvinToCelsius(weather.main.feels_like,1,true)}</h5>
                           ...
                           <div className="row mt-4">
                              <div className="col">
                                 ...
                                 <p className="temp">{KelvinToCelsius(forecast.list[1].main.temp,1,true)}</p>
                              </div>
                              <div className="col">
                                 <p>{forecastDate6} h</p>
                                 <p className="description"><img src={iconUrl6} alt="icon"/>{forecast.list[2].weather[0].description}</p>
                                 <p className="temp">{KelvinToCelsius(forecast.list[2].main.temp,1,true)}</p>
                              </div>
                              <div className="col">
                                 <p>{forecastDate9} h</p>
                                 <p className="description"><img src={iconUrl9} alt="icon"/>{forecast.list[3].weather[0].description}</p>
                                 <p className="temp">{KelvinToCelsius(forecast.list[3].main.temp,1,true)}</p>
                              </div>
                           </div>
                        </div>
                     </div>
